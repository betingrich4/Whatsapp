        ...
        Matrix.ev.on('connection.update', async (update) => {
            ...
            if (connection === 'close') {
                ...
                try {
                    ...
                    await Matrix.updateProfileStatus(statusText);
                    console.log(chalk.green("Status updated silently"));
                } catch (err) {
                    console.log(chalk.yellow("Couldn't auto-update status (API limitation)"));
                }
